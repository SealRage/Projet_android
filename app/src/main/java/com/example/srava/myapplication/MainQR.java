...
/**
 * Created by ginetro on 02/03/2016.
 */
public class MainQR extends Activity {
    private static final String TAG = "MainQR";
    ...
    public void onClickGenerateSquare(View view) {
        ...
        mTextDesc.setVisibility(View.GONE);
        mProgress.setVisibility(View.VISIBLE);
        new AsyncGenerateQRCode().execute(GenrateQR.MARGIN_AUTOMATIC);
    }
    ...
    private class AsyncGenerateQRCode extends AsyncTask<Integer, Void, Integer> {
        ...
        protected Integer doInBackground(Integer... params) {
            ...
            try {
                ...
                mBitmapQR = GenrateQR.generateBitmap(mEncodeString, width, height,
